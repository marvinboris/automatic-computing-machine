...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/Add.js":
/*!*********************************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/Add.js ***!
  \*********************************************************************************************/
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  function Add() {
    ...
    _defineProperty(_assertThisInitialized(_this), "submitHandler", function (e) {
      ...
      _this.props.onSubmit(_this.props.match.params.actionId, e.target);
    });
  ...
  _createClass(Add, [{
    ...
    value: function render() {
      ...
      var units = this.props.backend.actions.units;
      if (!units) units = [];
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onSubmit: function onSubmit(actionId, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_7__["postSubActionsStore"](actionId, data));
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/Edit.js":
/*!**********************************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/Edit.js ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  function Edit() {
    ...
    _defineProperty(_assertThisInitialized(_this), "submitHandler", function (e) {
      ...
      _this.props.submit(_this.props.match.params.actionId, _this.state.id, _this.state);
    });
  ...
  _createClass(Edit, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.subAction && prevState.action_id === '') return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_8__["updateObject"])(prevState, _objectSpread({}, nextProps.subAction));
      return prevState;
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    submit: function submit(actionId, id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_7__["patchSubActionsUpdate"](actionId, id, data));
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/View.js":
/*!**********************************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/View.js ***!
  \**********************************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref2) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], {
    ...
    className: "mr-2",
    fixedWidth: true
  }), "D\xE9tails de la sous-op\xE9ration"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Action"
  }, subAction.action), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Nom"
  }, subAction.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Unit\xE9"
  }, subAction.unit), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Prix"
  }, subAction.price)));
});
...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/index.js":
/*!***************************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/SubActions/index.js ***!
  \***************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Actions_Edit__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Actions/Edit */ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/Edit.js");
/* harmony import */ var _Actions_Add__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Actions/Add */ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/Add.js");
/* harmony import */ var _Actions_View__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Actions/View */ "./resources/js/src/containers/Backend/User/Services/Actions/SubActions/Actions/View.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      if (loading) content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        ...
        if (actions) {
          var action = actions.find(function (action) {
            return +action.id === +_this.props.match.params.actionId;
          });
          var subActions;
          if (action) subActions = _toConsumableArray(action.sub_actions);else subActions = [];
          ...
          var data = subActions.map(function (subAction) {
            ...
            return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_19__["updateObject"])(subAction, {
              actions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
                ...
                title: 'Détails de la sous-opération: ' + subAction.name,
                content: viewContent
                ...
                title: 'Modifier la sous-opération: ' + subAction.name,
                content: editContent
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
                ...
                deleteAction: function deleteAction() {
                  return _this.props["delete"](_this.props.match.params.actionId, subAction.id);
                }
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
          ...
          content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_List_List__WEBPACK_IMPORTED_MODULE_9__["default"], {
            array: data,
            data: JSON.stringify(subActions),
            bordered: true,
            add: "Ajouter une sous-op\xE9ration",
            ...
            title: "Sous-op\xE9rations",
            className: "bg-white shadow-sm",
            fields: [{
              name: 'Nom de l\'opération',
              key: 'action'
            }, {
              name: 'Nom de la sous-opération',
              key: 'name'
            }, {
              name: 'Unité',
              key: 'unit'
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        main: "Sous-op\xE9rations",
        items: [{
          to: '/user/services/actions',
          content: 'Opérations'
        }],
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faCalendarAlt"]
        ...
        user: true
      }, "Sous-op\xE9rations")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-4 pb-0"
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    "delete": function _delete(actionId, id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_18__["deleteSubActions"](actionId, id));
    }
  };
};
