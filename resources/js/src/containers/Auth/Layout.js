        ...
        return <div className="vh-100 d-flex flex-column bg-blue">
            ...
            <div className="bg-black-20 text-white border-top border-yellow-50 pt-5 pb-3 d-flex justify-content-center">
                <div>
                    ...
                    <div>
                        <span className="text-700 text-yellow">&copy;</span> Copyright {new Date().getFullYear()} <span className="text-700">CAR MAIN Vehicle Maintenance Management System</span>. All rights reserved by <span className="text-700 text-yellow">HEE Metal</span>. Made with <FontAwesomeIcon icon={faCoffee} className="text-yellow" /> by <a href="mailto:jaris.ultio.21@gmail.com" className="text-decoration-none">Brainer 21</a>.
                    </div>
                </div>
            </div>
            {/* <Footer /> */}
