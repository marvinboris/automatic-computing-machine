...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/Actions/Add.js":
/*!**********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/Actions/Add.js ***!
  \**********************************************************************************/
  ...
  _createClass(Add, [{
    ...
    value: function render() {
      var _this$state = this.state,
          organ_id = _this$state.organ_id,
          price = _this$state.price,
          unit_id = _this$state.unit_id,
          name = _this$state.name;
      var _this$props$backend$a = this.props.backend.actions,
          organs = _this$props$backend$a.organs,
          units = _this$props$backend$a.units;
      if (!organs) organs = [];
      if (!units) units = [];
      var organsOptions = organs.map(function (item) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", {
          value: item.id,
          key: JSON.stringify(item)
        }, item.name);
      });
      var unitsOptions = units.map(function (item) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", {
          value: item.id,
          key: JSON.stringify(item)
        }, item.name);
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["Form"], {
        ...
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__["faTrain"],
        validation: {
          required: true
        },
        required: true,
        value: organ_id
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", null, "S\xE9lectionner un organe"), organsOptions), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_5__["default"], {
        className: "col-lg-6",
        type: "select",
        name: "unit_id",
        onChange: this.inputChangedHandler,
        placeholder: "Unit\xE9",
        ...
        required: true,
        value: unit_id
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("option", null, "S\xE9lectionner une unit\xE9"), unitsOptions), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_5__["default"], {
        className: "col-lg-6",
        type: "text",
        name: "name",
        placeholder: "Nom",
        onChange: this.inputChangedHandler,
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_4__["faStickyNote"],
        validation: {
          required: true
        },
        required: true,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onSubmit: function onSubmit(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_7__["postActionsStore"](data));
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/Actions/Edit.js":
/*!***********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/Actions/Edit.js ***!
  \***********************************************************************************/
/*! exports provided: default */
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Edit, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.action && prevState.organ_id === '') return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_8__["updateObject"])(prevState, _objectSpread({}, nextProps.action));
      return prevState;
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    submit: function submit(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_7__["patchActionsUpdate"](id, data));
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/Actions/View.js":
/*!***********************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/Actions/View.js ***!
  \***********************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref2) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], {
    ...
    className: "mr-2",
    fixedWidth: true
  }), "D\xE9tails de l'op\xE9ration"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Organe"
  }, action.organ), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Nom"
  }, action.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Unit\xE9"
  }, action.unit), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Prix"
  }, action.price)));
});
...
/***/ "./resources/js/src/containers/Backend/User/Services/Actions/index.js":
/*!****************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Services/Actions/index.js ***!
  \****************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Actions_Edit__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./Actions/Edit */ "./resources/js/src/containers/Backend/User/Services/Actions/Actions/Edit.js");
/* harmony import */ var _Actions_Add__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Actions/Add */ "./resources/js/src/containers/Backend/User/Services/Actions/Actions/Add.js");
/* harmony import */ var _Actions_View__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Actions/View */ "./resources/js/src/containers/Backend/User/Services/Actions/Actions/View.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props$backend$a = this.props.backend.actions,
          ...
          actions = _this$props$backend$a.actions;
      var content;
      var errors;
      var feedback;
      if (loading) content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        ...
        if (actions) {
          feedback = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Feedback_Feedback__WEBPACK_IMPORTED_MODULE_12__["default"], {
            message: message
          });
          var data = actions.map(function (action) {
            var viewContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Actions_View__WEBPACK_IMPORTED_MODULE_17__["default"], {
              action: action
            });
            var editContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Actions_Edit__WEBPACK_IMPORTED_MODULE_15__["default"], {
              action: action
            });
            return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_19__["updateObject"])(action, {
              sub_actions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
                to: '/user/services/actions/' + action.id + '/sub-actions/',
                ...
                fixedWidth: true
              }), " ", action.sub_actions.length, " sous-op\xE9ration", action.sub_actions.length > 1 ? 's' : '')),
              action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
                ...
                title: 'Détails de l\'opération: ' + action.name,
                content: viewContent
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
                ...
                title: 'Modifier l\'opération: ' + action.name,
                content: editContent
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
                icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faEdit"],
                className: "text-brokenblue",
                fixedWidth: true
              })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_Delete_Delete__WEBPACK_IMPORTED_MODULE_13__["default"], {
                deleteAction: function deleteAction() {
                  return _this.props["delete"](action.id);
                }
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
          ...
          content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_List_List__WEBPACK_IMPORTED_MODULE_9__["default"], {
            ...
            bordered: true,
            add: "Ajouter une op\xE9ration",
            content: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Actions_Add__WEBPACK_IMPORTED_MODULE_16__["default"], null),
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        user: true
      }, "Op\xE9rations")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-4 pb-0"
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_18__["actionsReset"]());
    },
    get: function get() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_18__["getActions"]());
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_18__["deleteActions"](id));
    }
  };
};
