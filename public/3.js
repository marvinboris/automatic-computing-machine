...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_2__["Col"], {
    ...
    className: "rounded-4 d-flex justify-content-between align-items-center mb-5 mt-3 py-4 px-4 text-large ".concat(className)
    ...
    className: "table-nonfluid ".concat(innerClassName)
